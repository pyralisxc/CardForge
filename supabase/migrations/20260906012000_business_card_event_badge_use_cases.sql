...
-- Extend the native owner classification allowlist. Existing tag-shape checks
-- already accept these canonical IDs; leave identity, CAS and permissions intact.
