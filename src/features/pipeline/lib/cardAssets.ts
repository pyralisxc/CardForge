...
export type CardAssetMetadataOverride = Partial<Pick<
  CardAssetOption,
  'id' | 'name' | 'tileMode' | 'seamless' | 'allowedTargets' | 'defaultBlendMode' | 'defaultOpacity' | 'defaultScale' | 'defaultWidth' | 'defaultHeight' | 'packId' | 'packName' | 'studioDestinations' | 'studioOrder' | 'studioFeatured' | 'studioRoutingMode' | 'studioDefaultDestination' | 'compatibleOrientations' | 'style'
>>;
