...
export const registerAgentCardTools = ({
  ...
  server.registerTool(
    'preview_card_set',
    {
      title: 'Review a CardForge card set before applying it in Studio',
      description: 'Review the current agent Set structure, card values, stable ids, artwork resolution, and whether this exact revision has been applied to a browser workspace. Embedded artwork bytes are omitted from model context.',
