...
import { gptTemplateDraftInputSchema } from '../model';
...
} from './mcpTemplateToolResults';
import { searchStudioCreationLibrary } from './studioCreationLibrary';
import {
...
export const registerEditableTemplateTools = ({
  server,
  publicOrigin,
  getAccess,
  toolError,
  ...
  const runObservedMcpTool = async <Result>({
    toolName,
    input,
    execute,
  }: {
