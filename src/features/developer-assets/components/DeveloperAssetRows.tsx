          ...
          <div className="text-sm leading-6 text-[var(--cf-text-muted)]">
            ...
            <div className="mt-3 grid gap-3 md:grid-cols-3">
              <div className="border border-[var(--cf-border-subtle)] bg-[var(--cf-surface-inset)] p-3">
                ...
                <p className="mt-1 text-xs leading-5 text-[var(--cf-text-muted)]">{getDeveloperAssetStatusDescription(submission.status)}</p>
              </div>
              <div className="border border-[var(--cf-border-subtle)] bg-[var(--cf-surface-inset)] p-3">
                <p className="text-xs uppercase tracking-[0.12em] text-[var(--cf-text-subtle)]">Tier meaning</p>
                <p className="mt-1 text-xs leading-5 text-[var(--cf-text-muted)]">{getDeveloperAssetTierDescription(submission.calculatedAccessTier)}</p>
              </div>
              <div className="border border-[var(--cf-border-subtle)] bg-[var(--cf-surface-inset)] p-3">
            ...
            <dl className="mt-3 grid gap-2 text-xs text-[var(--cf-text-subtle)] sm:grid-cols-2">
              ...
              <div><dt className="uppercase tracking-[0.12em]">Automatic result</dt><dd className="break-all text-[var(--cf-text-muted)]">{getDeveloperAssetStatusLabel(submission.automatedStatus)} / {getDeveloperAssetTierLabel(submission.automatedAccessTier)}</dd></div>
              ...
              <div><dt className="uppercase tracking-[0.12em]">Studio placement</dt><dd className="text-[var(--cf-text-muted)]">{submission.requestedStudioDestination ? getDeveloperAssetStudioDestinationLabel(submission.requestedStudioDestination) : 'Not confirmed'}</dd></div>
