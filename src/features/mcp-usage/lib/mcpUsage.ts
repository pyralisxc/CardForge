...
export const DEFAULT_MCP_ALLOWANCES: McpAllowance[] = [
  { planKey: 'free', displayName: 'Free', priceLabel: '$0', priceNote: 'No card required', description: 'Explore CardForge on your local-first Desk and try CardForge for ChatGPT.', featureSummary: 'Local-first Desk and focused design tools\nSets saved on this device\n30 ChatGPT actions each month\n250 MB private ChatGPT workspace', ctaLabel: 'Start creating', isVisible: true, monthlyActionLimit: 30, dailySafetyLimit: 5, onlineStorageLimitBytes: mebibytes(250), draftRetentionHours: 12 },
  { planKey: 'creator', displayName: 'Creator Pass', priceLabel: '$8.99', priceNote: 'per month', description: 'For regular creators who want clean finished exports, portable project files, and more ChatGPT capacity.', featureSummary: 'Everything in Free\nWatermark-free finished exports\nPortable CardForge project files\n300 ChatGPT actions each month\n2 GB private ChatGPT workspace', ctaLabel: 'Choose Creator', isVisible: true, monthlyActionLimit: 300, dailySafetyLimit: 50, onlineStorageLimitBytes: gibibytes(2), draftRetentionHours: 24 },
