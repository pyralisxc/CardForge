...
export function CardSetManager() {
  ...
  return (
    <div className="mb-4 grid gap-3 rounded-md border bg-background/60 p-3 md:grid-cols-[minmax(0,1fr)_auto] md:items-end">
      <div className="space-y-1">
        ...
        <p className="text-xs text-muted-foreground">Sets are saved in this browser workspace. Switching sets changes which cards you create, review, and export.</p>
      </div>
