export const makerTheme = {
  shell: 'border-[var(--cf-editor-border)] bg-[var(--cf-editor-shell)] text-[var(--cf-editor-text)] shadow-[0_28px_90px_rgba(0,0,0,0.6)]',
  panel: 'border-[var(--cf-editor-border)] bg-[var(--cf-editor-surface)]',
  panelInset: 'border-[var(--cf-editor-border)] bg-[var(--cf-editor-inset)]',
  goldPanel: 'border-[var(--cf-editor-accent-border)] bg-[var(--cf-surface-inset)]',
  goldText: 'text-[var(--cf-editor-accent)]',
  mutedText: 'text-[var(--cf-editor-muted)]',
