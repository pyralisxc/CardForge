...
export const SITE_CONTENT_DEFINITIONS = [
  ...
  { slug: 'landing.hero.headline', group: 'landing', section: 'Hero', label: 'Headline', body: 'Shape the system. Build the Set. Keep the work yours.', kind: 'short', maxLength: 160 },
  { slug: 'landing.hero.body', group: 'landing', section: 'Hero', label: 'Introduction', body: 'Design reusable front and back layouts, generate a complete Set from structured content, arrange it on your Desk, and carry the same work through review and export without giving up control of the source.', kind: 'long', maxLength: 500 },
  { slug: 'landing.hero.support', group: 'landing', section: 'Hero', label: 'Eyebrow', body: 'One focused Desk. A broad Library. The same work from idea to export.', kind: 'short', maxLength: 120 },
  ...
  { slug: 'landing.showcase.headline', group: 'landing', section: 'Product showcase', label: 'Headline', body: 'Design precisely, build the whole Set, and keep every stage connected.', kind: 'short', maxLength: 180 },
  { slug: 'landing.showcase.body', group: 'landing', section: 'Product showcase', label: 'Introduction', body: "This walkthrough uses CardForge's real Templates, sample rows, and card renderer. The Desk holds the work in focus, Studio handles detailed creation, and Library keeps the wider collection within reach.", kind: 'long', maxLength: 500 },
  ...
  { slug: 'landing.workflow.headline', group: 'landing', section: 'Workflow', label: 'Headline', body: 'One connected path from focused work to a finished Set.', kind: 'short', maxLength: 180 },
  { slug: 'landing.workflow.step1.title', group: 'landing', section: 'Workflow steps', label: 'Step 1 title', body: 'Focus on the Desk', kind: 'short', maxLength: 100 },
  { slug: 'landing.workflow.step1.body', group: 'landing', section: 'Workflow steps', label: 'Step 1 description', body: 'Bring the Sets and materials you need now into one spatial working surface.', kind: 'long', maxLength: 300 },
  { slug: 'landing.workflow.step2.title', group: 'landing', section: 'Workflow steps', label: 'Step 2 title', body: 'Design in Studio', kind: 'short', maxLength: 100 },
  { slug: 'landing.workflow.step2.body', group: 'landing', section: 'Workflow steps', label: 'Step 2 description', body: 'Build reusable front and back layouts, then tune individual Artifacts without leaving the work behind.', kind: 'long', maxLength: 300 },
  { slug: 'landing.workflow.step3.title', group: 'landing', section: 'Workflow steps', label: 'Step 3 title', body: 'Build and review the Set', kind: 'short', maxLength: 100 },
  { slug: 'landing.workflow.step3.body', group: 'landing', section: 'Workflow steps', label: 'Step 3 description', body: 'Generate from structured content, inspect the complete run, and revise the exact pieces that need attention.', kind: 'long', maxLength: 300 },
  { slug: 'landing.workflow.step4.title', group: 'landing', section: 'Workflow steps', label: 'Step 4 title', body: 'Share or export', kind: 'short', maxLength: 100 },
  { slug: 'landing.workflow.step4.body', group: 'landing', section: 'Workflow steps', label: 'Step 4 description', body: 'Export finished files or send eligible work through the governed Pipeline while your working copy stays yours.', kind: 'long', maxLength: 300 },
  ...
  { slug: 'landing.access.developer-note', group: 'landing', section: 'Access', label: 'Development beta note', body: 'CardForge for ChatGPT is in development beta through ChatGPT Developer Mode. Availability depends on your ChatGPT access while review is in progress.', kind: 'long', maxLength: 300 },
  ...
  { slug: 'landing.final.headline', group: 'landing', section: 'Final action', label: 'Headline', body: 'Put your next Set on the Desk.', kind: 'short', maxLength: 140 },
  { slug: 'landing.final.body', group: 'landing', section: 'Final action', label: 'Introduction', body: 'Start locally, choose a published foundation or make your own, and carry the work from the first layout to finished output.', kind: 'long', maxLength: 350 },
  ...
  { slug: 'plans.beta.note', group: 'plans', section: 'Development beta', label: 'ChatGPT availability note', body: 'CardForge for ChatGPT is in development beta through ChatGPT Developer Mode. Availability depends on your ChatGPT access while review is in progress.', kind: 'long', maxLength: 320 },
  ...
  { slug: 'sharing.message', group: 'sharing', section: 'Social sharing', label: 'Default share message', body: 'Check out CardForge—a local-first creative workspace for designing, building, reviewing, and exporting complete card Sets from one focused Desk.', kind: 'long', maxLength: 500 },
