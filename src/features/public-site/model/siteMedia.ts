...
const showcaseArtwork = [
  { slot: 'landing.showcase.art.playing.ace', label: 'Arcane Court — Ace artwork', defaultSrc: '/site-fallbacks/showcase/playing-cards/ace-of-spades.webp', defaultAlt: 'Night Sentinel artwork for the Arcane Court ace of spades', width: 720, height: 1186 },
  { slot: 'landing.showcase.art.playing.king', label: 'Arcane Court — King artwork', defaultSrc: '/site-fallbacks/showcase/playing-cards/king-of-hearts.webp', defaultAlt: 'Rosebound King artwork for the Arcane Court king of hearts', width: 720, height: 1080 },
  { slot: 'landing.showcase.art.playing.queen', label: 'Arcane Court — Queen artwork', defaultSrc: '/site-fallbacks/showcase/playing-cards/queen-of-diamonds.webp', defaultAlt: 'Prism Sovereign artwork for the Arcane Court queen of diamonds', width: 720, height: 1080 },
  { slot: 'landing.showcase.art.playing.jack', label: 'Arcane Court — Jack artwork', defaultSrc: '/site-fallbacks/showcase/playing-cards/jack-of-clubs.webp', defaultAlt: 'Greenwood Tinker artwork for the Arcane Court jack of clubs', width: 720, height: 1080 },
  { slot: 'landing.showcase.art.creature.emberclaw', label: 'Bestiary — Emberclaw artwork', defaultSrc: '/site-fallbacks/showcase/creatures/emberclaw-whelp.webp', defaultAlt: 'Emberclaw Whelp artwork for the Arcane Creature Bestiary', width: 960, height: 640 },
  { slot: 'landing.showcase.art.creature.mossback', label: 'Bestiary — Mossback artwork', defaultSrc: '/site-fallbacks/showcase/creatures/mossback-guardian.webp', defaultAlt: 'Mossback Guardian artwork for the Arcane Creature Bestiary', width: 960, height: 640 },
  { slot: 'landing.showcase.art.creature.moonveil', label: 'Bestiary — Moonveil artwork', defaultSrc: '/site-fallbacks/showcase/creatures/moonveil-stag.webp', defaultAlt: 'Moonveil Stag artwork for the Arcane Creature Bestiary', width: 960, height: 640 },
  { slot: 'landing.showcase.art.creature.stormglass', label: 'Bestiary — Stormglass artwork', defaultSrc: '/site-fallbacks/showcase/creatures/stormglass-siren.webp', defaultAlt: 'Stormglass Siren artwork for the Arcane Creature Bestiary', width: 960, height: 640 },
...
export const DEFAULT_SITE_MEDIA: SiteMediaDefaults[] = [
  ...
  },
  {
    ...
    defaultSrc: '/site-fallbacks/showcase/cardforge-workshop-cover.webp',
  ...
  },
  {
    ...
    defaultSrc: '/site-fallbacks/showcase/studio-generator-single.jpg',
  ...
  },
  {
    ...
    guidance: 'A tall Studio screenshot works well here. Natural framing keeps the entire workflow visible and scrollable.',
    defaultSrc: '/site-fallbacks/showcase/studio-generator-bulk.jpg',
