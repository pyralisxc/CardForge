...
export default async function CameronPage() {
  ...
  return (
    <CardForgeAppProviders>
      <PublicSiteShell accountSlot={authConfigured ? <DeveloperPublicAuthControls /> : undefined} businessIdentity={businessIdentity} currentPath="/cameron" siteConfiguration={siteConfiguration}>
