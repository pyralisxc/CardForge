...
const accessRows = [
  ...
  {
    label: 'Add your art',
    detail: 'Create an account when you want signed-in local asset uploads and a steadier workspace.',
  },
  {
    label: 'Export clean files',
    detail: 'Creator Pass unlocks clean exports and a stronger library for production-ready prototypes.',
  },
];
    ...
    <main className="min-h-screen overflow-hidden bg-[#0c0b09] text-[#f7ead0]">
      <section className="relative min-h-[74vh] border-b border-[#8b6a34]/35">
        ...
        <header className="relative z-10 mx-auto flex max-w-7xl items-center justify-between px-5 py-5 md:px-8">
          <Link href="/" className="flex items-center gap-3 text-[#f9e7b7]">
            <span className="grid h-10 w-10 place-items-center border border-[#d7b469]/70 bg-[#140f0a]/80 text-[#f2c15d] shadow-[0_0_28px_rgba(242,149,48,0.18)]">
              <Hammer className="h-5 w-5" />
            </span>
            <span className="font-serif text-xl font-semibold tracking-wide">CardForge Studio</span>
          </Link>
          ...
          <Button asChild className="hidden bg-[#d69c3a] text-[#16100a] hover:bg-[#f1bd58] md:inline-flex">
          ...
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <Button asChild className="bg-[#d69c3a] text-[#16100a] hover:bg-[#f1bd58]">
                <Link href="/studio" prefetch={false}>Try the editor</Link>
              </Button>
      ...
      <section className="bg-[#0c0b09] px-5 py-12 md:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.85fr_1.15fr]">
          <div>
            ...
            <p className="mt-4 text-sm leading-6 text-[#cbb58b]">
              You can explore the maker and generator before signing in. Accounts matter when you want custom art uploads, cleaner exports, Creator Pass assets, or the developer contribution path.
            </p>
      ...
      <section className="border-t border-[#5c4324]/50 bg-[#100d09] px-5 py-12 md:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-sm leading-6 text-[#cbb58b]">
              Start with official defaults, add your own browser-local art, and unlock stronger libraries as your workflow grows. The goal is simple: less setup, better cards.
            </p>
          </div>
      ...
      <section className="border-t border-[#5c4324]/50 bg-[#15100a] px-5 py-10 md:px-8">
        <div className="mx-auto flex max-w-7xl flex-col gap-6 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <Button asChild size="lg" className="bg-[#e4aa43] text-[#140f0a] hover:bg-[#f4c66b]">
              <Link href="/studio" prefetch={false}>
                Launch CardForge <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
            </Button>
