...
export default function ConductorTermsPage() {
  return (
    <article className="space-y-7 leading-7">
      ...
      <section className="space-y-2"><h2 className="text-xl font-semibold text-[#D2B66C]">Authorized use</h2><p>We grant an authorized user a limited, nonexclusive, nontransferable right to use this integration with their permitted Vercel account or team while the integration is available. You must have permission to install it and access the selected projects. The connection initially permits Conductor to inspect project, deployment, and domain information. Any later capability to change deployments or project settings requires a separate permission change and authorization.</p></section>
