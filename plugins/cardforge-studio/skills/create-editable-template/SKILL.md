...
5. Attach required fixed artwork to its planned native targets, then call `preview_template_draft` after meaningful changes until the exact render is correct.
