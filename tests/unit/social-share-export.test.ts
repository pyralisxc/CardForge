...
import { getSocialShareLayout, SOCIAL_SHARE_PRESETS } from '@/features/card-generator/lib/socialShareExport';
...
describe('social share export', () => {
  ...
  it('centers the card while reserving a branded attribution footer', () => {
    ...
    expect(layout.watermark).toBe('CardForge • cardforges.com');
