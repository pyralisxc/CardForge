...
const project = {
  ...
  providerRevision: 'head:' + '7'.repeat(64),
  ...
  it('accepts stable Drive work identity in list, checkout, and commit responses', async () => {
    ...
    const cases: Array<[unknown, unknown]> = [
      ...
      [commitProjectOutputSchema, {
        status: 'committed',
        linkageFailure: null,
        source: { ...project, providerRevision: 'head:' + '8'.repeat(64) },
        documentId: 'a7e209ae-ea44-43ae-a2cb-718a972beef4',
        documentRevision: 2,
        previousProviderRevision: 'head:' + '7'.repeat(64),
      ...
      [commitProjectOutputSchema, {
        ...
        source: { ...project, providerRevision: 'head:' + '8'.repeat(64), projectRevision: 'b'.repeat(64) },
        documentId: 'a7e209ae-ea44-43ae-a2cb-718a972beef4',
        documentRevision: 2,
        previousProviderRevision: 'head:' + '7'.repeat(64),
        previousProjectRevision: 'a'.repeat(64),
  ...
  it('accepts the personal-library search payload returned by search_personal_library', async () => {
    const result = await validate(personalLibrarySearchOutputSchema, {
      ...
      items: [{
        ...
        mimeType: 'image/png',
        byteSize: 1024,
        providerRevision: 'head:' + '4'.repeat(64),
        contentHash: null,
      }],
